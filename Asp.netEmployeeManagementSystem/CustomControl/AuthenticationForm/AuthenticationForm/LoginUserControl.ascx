    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style7">
                <asp:Button ID="LoginButton" runat="server" OnClick="LoginButton_Click" style="text-align: center; height: 26px;" Text="Login" Width="82px" />
            </td>
            <td class="auto-style5">
        ...
        <tr>
            <td class="auto-style7">
                <asp:CheckBox ID="CheckBoxRemember" runat="server" Font-Size="X-Small" Text="Remember Me?" />
            </td>
