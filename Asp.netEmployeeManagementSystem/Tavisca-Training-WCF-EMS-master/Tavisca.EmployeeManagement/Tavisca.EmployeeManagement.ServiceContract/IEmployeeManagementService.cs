...
namespace Tavisca.EmployeeManagement.ServiceContract
{
    ...
    public interface IEmployeeManagementService
    {
        ...
        [WebInvoke(Method = "POST", UriTemplate = "employee/{employeeEmail}/changePassword", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]      //remove1
        String ChangePassword(string employeeEmail, string newPassword);
    }
}
