<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WidgetDemo.ascx.cs" Inherits="WidgetDemo.WidgetDemo" %>
...
<asp:Table ID="Table1" runat="server" Visible="true" Height="115px" Width="16px">
    <asp:TableRow>
        <asp:TableHeaderCell>
